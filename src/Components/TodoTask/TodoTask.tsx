...
const TodoTask = ({ task, completeTask }: Props) => {
	...
	return (
    	<div className='task'>
        	...
        	<button className='task_check' onClick={() => {completeTask(task.taskName)}}>
          		<svg className='task_check__svg' width="26" height="26" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
